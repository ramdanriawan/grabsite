...
<html>
  <head>
    ...
    <script src="\node_modules\bootstrap\dist\js\bootstrap.min.js" charset="utf-8"></script>
...
<header class="header">
      <div class="row">
        ...
        <div class="col-md-6 col-xs-12">
          <h2 class="fontopensansbold"><a href="/">My Site</a></h2>
        </div>
...
<!--  menu navigasi -->
  <nav class="navigasi">
    ...
    <ul class="nav nav-tabs nav-justified text-capitalize">
      <li class="active"><a class="active" href="#menu1">News</a></li>
      <li><a href="#menu2">Ekonomi</a></li>
      <li><a href="#menu3">Bola</a></li>
      <li><a href="#menu4">Tekno</a></li>
      <li><a href="#menu5">Sains</a></li>
      <li><a href="#menu6">Entertainment</a></li>
      <li><a href="#menu7">Otomotif</a></li>
      <li><a href="#menu8">Lifestyle</a></li>
      <li><a href="#menu9">Property</a></li>
      <li><a href="#menu10">Travel</a></li>
    </ul>
  </nav>
